...
export default function ChapterUpdateCard({ chapter, story, index }) {
  ...
  return (
    ...
    >
      <Link to={`/story/${chapter.story_id}/chapter/${chapter.id}`} className="flex flex-col sm:flex-row">
        {story?.cover_image && (
        ...
        <div className="flex-1 p-5 min-w-0">
          ...
          <p className="text-xs text-primary font-medium mb-1">{story?.title || "Unknown Story"}</p>
