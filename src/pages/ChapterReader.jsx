...
const renderers = {
  ...
  h2: ({ children }) => <h2 className="font-heading text-xl font-semibold mt-10 mb-4">{children}</h2>,
  h3: ({ children }) => <h3 className="font-heading text-lg font-semibold mt-8 mb-3">{children}</h3>,
  ...
  blockquote: ({ children }) => <blockquote className="border-l-2 border-primary/40 pl-5 my-6 italic opacity-70">{children}</blockquote>,
  hr: () => <div className="flex items-center justify-center gap-2 my-10"><div className="h-px w-12 bg-primary/30" /><div className="w-1.5 h-1.5 rounded-full bg-accent/60" /><div className="h-px w-12 bg-primary/30" /></div>,
};
