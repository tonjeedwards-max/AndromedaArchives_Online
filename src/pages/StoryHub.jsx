        ...
        <div className="flex flex-col md:flex-row gap-8">
          {story.cover_image && (
            <div className="w-40 md:w-48 shrink-0 mx-auto md:mx-0">
              <div className="aspect-[2/3] rounded-lg overflow-hidden shadow-xl shadow-primary/15 ring-1 ring-border/40 relative">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-3 flex-wrap mb-2">
              ...
              {asArray(story.tags).slice().sort((a, b) => String(a).localeCompare(String(b))).slice(0, 3).map((tag) => (
